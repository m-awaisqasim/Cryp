...
**Goals:**
- Deliver a spoken daily briefing on the first Cryp startup of each calendar day
...
- Respect conversation state: never speak while Cryp is in an active tool call, mid-response, or user is speaking
